...
var components_components_module = __webpack_require__(684);
...
var entry_AddonModGlossaryEntryPage = /** @class */ (function () {
    ...
    AddonModGlossaryEntryPage.prototype.ionViewDidLoad = function () {
        ...
        this.fetchEntry().then(function () {
            _this.glossaryProvider.logEntryView(_this.entry.id, _this.componentId).catch(function () {
                // Ignore errors.
            });
        }).finally(function () {
            _this.loaded = true;
...
function View_AddonModGlossaryEntryPage_10(_l) { return core["_57" /* ɵvid */](0, [(_l()(), core["_31" /* ɵeld */](0, 0, null, null, 1, "core-rating-rate", [["contextLevel", "module"]], null, [[null, "onUpdate"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("onUpdate" === en)) {
